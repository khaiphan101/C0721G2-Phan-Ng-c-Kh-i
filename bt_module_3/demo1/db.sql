...
foreign key (id_premise_type) references premise_type(id_premise_type)  on delete cascade
 ...
 (3, 'All-inclusive office');
  ...
  ('LDH-00-10', 1, 35, 15, 1, 2000000, '2019-11-01', '2021-11-01'),
  ('LDH-00-11', 2, 40, 15, 3, 3000000, '2019-08-01', '2021-08-01'),
  ('LDH-00-13', 3, 21, 15, 2, 1500000, '2019-07-01', '2021-07-01'),
  ('LDH-00-14', 1, 30, 15, 2, 2500000, '2019-03-01', '2021-03-01');
