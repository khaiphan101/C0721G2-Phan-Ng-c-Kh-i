...
import repository.impl.premise.PremiseTypeImpl;
import repository.impl.premise.StatusImpl;
import service.PremiseService;
import service.impl.PremiseServiceImpl;
...
@WebServlet(name = "PremiseServlet", urlPatterns = {"/premise"})
public class PremiseServlet extends HttpServlet {
    private PremiseService premiseService;

    public void init() {
        premiseService = new PremiseServiceImpl();
    }
...
//                    delete(request, response);
    ...
    private void showList(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Premise> premiseList = premiseService.selectAll();
        request.setAttribute("list", premiseList);
        request.getRequestDispatcher("premise/list.jsp").forward(request, response);
    }
